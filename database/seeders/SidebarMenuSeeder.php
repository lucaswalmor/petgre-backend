...
class SidebarMenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $subItens = [
            ['chave' => 'cadastros.servicos', 'label' => 'Serviços', 'path' => '/dashboard/servicos', 'icon' => 'pi pi-calendar', 'permission_slug' => 'servicos.index', 'parent_id' => $cadastrosId, 'ordem' => 1],
            ['chave' => 'cadastros.produtos', 'label' => 'Produtos', 'path' => '/dashboard/produtos', 'icon' => 'pi pi-shopping-bag', 'permission_slug' => 'produtos.index', 'parent_id' => $cadastrosId, 'ordem' => 2],
            ['chave' => 'cadastros.kits', 'label' => 'KITs', 'path' => '/dashboard/kits', 'icon' => 'pi pi-box', 'permission_slug' => 'kits.index', 'parent_id' => $cadastrosId, 'ordem' => 3],
            ['chave' => 'cadastros.cupons', 'label' => 'Cupons', 'path' => '/dashboard/cupons', 'icon' => 'pi pi-tag', 'permission_slug' => 'cupons.index', 'parent_id' => $cadastrosId, 'ordem' => 4],
            ...
            ['chave' => 'config.ordenacao', 'label' => 'Configurar Loja', 'path' => '/dashboard/configurar-loja', 'icon' => 'pi pi-list', 'permission_slug' => 'empresas.update', 'parent_id' => $configuracoesId, 'ordem' => 7],
        ];
