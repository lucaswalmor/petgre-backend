...
As rotas exatas estão em `routes/api.php`; para testes manuais use a coleção Postman do projeto. Testes automatizados de API: `UsuarioControllerTest`, `EmpresaControllerTest`, `ProdutoControllerTest` (Feature).
